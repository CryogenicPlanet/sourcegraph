...
const CODE_INTEL = 'Getting more from code intel'
const TOOLS = 'Tools for improving workflow'
...
export const ONBOARDING_STEP_ITEMS: Omit<OnboardingTourStepItem, 'isCompleted'>[] = [
    ...
    // Group: CODE_INTEL
    {
        ...
        info: {
            ...
            content: `<p><strong>GETTING STARTED: Find references</strong><br/></p>
                    Hover over the highlighted token to open code intel, then click ‘Find References’ to locate all calls of this function.`,
        },
    ...
    },
    {
        ...
        info: {
            selector: '.onboarding-tour-info-marker',
            content: `<p><strong>GETTING STARTED: Go to definition</strong></p>
                Hover over the highlighted token to open code intel, then click ‘Go to definition’ to locate a token definition.`,
        },
